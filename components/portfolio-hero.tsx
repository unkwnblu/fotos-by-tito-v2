...
export function PortfolioHero({ images = [] }: { images?: string[] }) {
  ...
  return (
    <div className="relative h-[85vh] w-full overflow-hidden bg-background">
      ...
      {/* TOP LEFT GLASS PANEL */}
      <div className="absolute left-0 top-0 z-10 h-[40%] md:h-[50%] w-[85%] md:w-[35%] flex flex-col justify-center px-8 md:px-10 rounded-br-[3rem] md:rounded-br-[4rem] bg-white/30 backdrop-blur-md border-r border-b border-white/20 shadow-lg">
        ...
        <h1 className="mb-3 md:mb-6 text-3xl md:text-7xl font-serif font-medium tracking-tight text-foreground">
          VISUAL POETRY <br />
          <span className="text-emerald-900">IN PIXELS</span>
        </h1>
      ...
      <div className="absolute top-8 right-8 z-20">
        <a
          href="#gallery-start"
          className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/30 backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/40 transition-all group"
        >
      ...
      <div className="absolute top-[40%] md:top-[50%] left-6 z-20 md:left-10 -translate-y-1/2">
        <div className="flex h-12 w-12 md:h-24 md:w-24 items-center justify-center rounded-full bg-white/30 backdrop-blur-md border border-white/20 shadow-lg">
